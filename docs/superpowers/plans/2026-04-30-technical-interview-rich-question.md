...
- Create: `ai_interviewer_admin/src/main/resources/db/migration/V2__question_media.sql`
...
```sql
-- ai_interviewer_admin/src/main/resources/db/migration/V2__question_media.sql
...
```bash
git add ai_interviewer_admin/src/main/resources/db/migration/V2__question_media.sql \
  ai_interviewer_admin/src/main/java/com/aiinterviewer/admin/questionbank/entity/QuestionMedia.java \
  ai_interviewer_admin/src/main/java/com/aiinterviewer/admin/questionbank/dto/QuestionMediaRequest.java \
